...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Tipo de Disenador'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tipo-disenador-view container-fluid">

    <div class="row">
        <div class="col-md-6  col-sm-8">
            <h2><?= Yii::t('app', 'Tipo de Disenador').' '. Html::encode($this->title) ?></h2>
        </div>
